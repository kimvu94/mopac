...
def parallelrun_sh(n,user,mydir):
    ...
    p3 = '#SBATCH --partition=compute\n#SBATCH --account=chem\n\n'
    p4 = 'module load gnu/parallel/20210422\nmodule load chem/mopac/16\n'
    p5 = 'source /mmfs1/home/'+user+'/.rvm/scripts/rvm\n'
    p6 = 'ldd /mmfs1/sw/contrib/chem-src/cuby4/cuby4/classes/algebra/algebra_c.so > ldd.log\n'
